...
export default function PortionSelector({ value, onChange }: Props) {
  ...
  return (
    <div>
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">{t('portion.label')}</p>
          ...
          <button
            ...
            className={`rounded-lg px-3 py-1 text-sm font-medium border transition-colors ${
              value === p
                ...
                : 'border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:border-green-400 hover:text-green-700 dark:hover:text-green-400'
            }`}
          >
            {p}x
          </button>
