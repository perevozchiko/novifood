...
const dictionaries = {
  en: {
    ...
    'voice.waitingForAi': 'Waiting for AI response…',
    'voice.waitingHint': 'We are estimating the serving and nutrition per 100 g.',
    ...
    'voice.errorTimeout': 'Analysis took too long. Please try again.',
  ...
  ru: {
    ...
    'voice.waitingForAi': 'Ждём ответ от ИИ…',
    'voice.waitingHint': 'Определяем порцию и КБЖУ на 100 г.',
    ...
    'voice.errorTimeout': 'Анализ занял слишком много времени. Попробуйте снова.',
